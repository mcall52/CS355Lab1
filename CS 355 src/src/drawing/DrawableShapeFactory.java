...
public class DrawableShapeFactory {
	...
	public DrawableShape createShape(Shape shape){
		...
		if (shape instanceof Line){
			...
			newshape = new DrawableSquare(shape.getColor(), ((Square) shape).getUpperLeft(), ((Square) shape).getSize());
		}
		else if(shape instanceof Rectangle){
			newshape = new DrawableRectangle(shape.getColor(), ((Rectangle) shape).getUpperLeft(), ((Rectangle) shape).getWidth(), ((Rectangle) shape).getHeight());
		}
			...
			newshape = new DrawableTriangle(shape.getColor(), ((Triangle) shape).getA(), ((Triangle) shape).getB(), ((Triangle) shape).getC());
		}
		else{
			newshape = null;
		}
